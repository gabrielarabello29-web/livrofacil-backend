...
public class EstoqueRequest {
    ...
    @AssertTrue(message = "A quantidade bloqueada nao pode ser maior que a quantidade disponivel")
    public boolean isEstoqueCoerente() {
        return quantidadeDisponivel == null || quantidadeBloqueada == null
                || quantidadeBloqueada <= quantidadeDisponivel;
    }
