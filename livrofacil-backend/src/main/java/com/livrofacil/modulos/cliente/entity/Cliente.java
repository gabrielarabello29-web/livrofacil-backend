...
public class Cliente {
    ...
    @Column(name = "cli_numero_registro", nullable = false, unique = true)
    ...
    @Column(name = "cli_data_exclusao")
    private LocalDateTime dataExclusao;

    @Column(name = "cli_dados_anonimizados", nullable = false)
    ...
    public boolean isDadosAnonimizados() {
